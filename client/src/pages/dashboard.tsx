...
export default function Dashboard() {
  ...
  const generateMutation = useMutation({
    ...
    onSuccess: (data) => {
      // Handle both object and nested object response structures
      const responseText = typeof data.response === 'string' ? data.response : data.response?.response || "Response generated successfully";
